        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Edit Audit</h6>
                    <form method="post" action="/dashboard/audit/{{ $audit->nomor_lhp }}">
                        @method('put')
                        @csrf
                        <div class="mb-3">
                            <label for="kodeLaporan" class="form-label">Kode Laporan</label>
                            <input type="number" class="form-control @error('kodeLaporan') is-invalid @enderror" id="kodeLaporan" name="kodeLaporan" required autofocus value="{{ old('kodeLaporan', $audit->kodeLaporan) }}">
                            @error('kodeLaporan')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('nomor_lhp') is-invalid @enderror" id="nomor_lhp" name="nomor_lhp" required value="{{ old('nomor_lhp', $audit->nomor_lhp) }}">
                            @error('nomor_lhp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" required value="{{ old('judul', $audit->judul) }}">
                            @error('judul')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input id="latar_belakang" type="hidden" name="latar_belakang" value="{{ old('latar_belakang', $audit->latar_belakang) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="tujuan" type="hidden" name="tujuan" value="{{ old('tujuan', $audit->tujuan) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="waktu" type="hidden" name="waktu" value="{{ old('waktu', $audit->waktu) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="ruang_lingkup" type="hidden" name="ruang_lingkup" value="{{ old('ruang_lingkup', $audit->ruang_lingkup) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="hasil" type="hidden" name="hasil" value="{{ old('hasil', $audit->hasil) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="rekomendasi" type="hidden" name="rekomendasi" value="{{ old('rekomendasi', $audit->rekomendasi) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="kesimpulan" type="hidden" name="kesimpulan" value="{{ old('kesimpulan', $audit->kesimpulan) }}">
