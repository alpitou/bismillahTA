    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <tr>
                    ...
                    <td width="60%" style="text-align: justify;">Pejabat berwenang yang memberi perintah</td>
                    <td width="5%">:</td>
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td style="text-align: left; padding-left: 10px; white-space: nowrap;">{{ date('d F Y', strtotime($domisili->tglSurat)) }}</td>
                </tr>
            </table>
            <table width="513px" style="margin-top: 10px;">
                <tr>
                    <td width="60%"></td>
                    <td style="text-align: right; white-space: nowrap;">Ditandatangani oleh:</td>
                </tr>
            </table>
            <table width="581px" style="margin-top: 10px;">
                <tr>
                    <td width="65%"></td>
                    <td style="text-align: left; white-space: nowrap;">An. {{ $domisili->ttd }}</td>
                </tr>
            </table>
            <table width="581px" style="margin-bottom: 100px;">
                <tr>
                    <td width="65%"></td>
                    <td style="text-align: left; white-space: nowrap;">{{ $domisili->namaTtd }}</td>
                </tr>
            </table>
            </div>
        </div>
