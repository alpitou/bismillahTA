        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Buat Surat Jalan</h6>
                    <form method="post" action="/dashboard/domisili">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tempatTglLahir') is-invalid @enderror" id="tempatTglLahir" name="tempatTglLahir" placeholder="" required value="{{ old('tampatTglLahir') }}">
